...
- Vercel AI SDK (`ai`) for tool calling and structured output; the provider is an environment choice among OpenAI, Anthropic, and any OpenAI-compatible endpoint.
